...
add_filter( 'comments_clauses', array( 'FUE_Email_Logger', 'exclude_fue_comments' ), 10, 1 );
add_action( 'comment_feed_join', array( 'FUE_Email_Logger', 'exclude_fue_comments_from_feed_join' ) );
add_action( 'comment_feed_where', array( 'FUE_Email_Logger', 'exclude_fue_comments_from_feed_where' ) );
