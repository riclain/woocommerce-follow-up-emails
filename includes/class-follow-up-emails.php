...
class Follow_Up_Emails {
     ...
     */
    public static $db_version           = '7.19.4';
    ...
    public static function get_email_types() {
        ...
        $signup_props = apply_filters( 'fue_signup_email_properties', array(
            ...
            'short_description'     => __('Create emails to send when a user creates an account in your store, or signs up for a list.<br />Get going faster, and save time, with a starter pack of Follow-ups from Outbound Commerce.', 'follow_up_emails'),
            'long_description'      => __('Create emails to send when a user creates an account in your store, or signs up for a list.<br />Get going faster, and save time, with a starter pack of Follow-ups from Outbound Commerce.', 'follow_up_emails')
        ) );
        ...
        $manual_props = apply_filters( 'fue_manual_email_properties', array(
            ...
            'supports'              => array(),
            'durations'             => array(),
            'short_description'     => __('Create manual emails to have templates for ad-hoc emails to customers and prospects.<br />Get going faster, and save time, with a starter pack of Follow-ups from Outbound Commerce.', 'follow_up_emails'),
            'long_description'      => __('Create manual emails to have templates for ad-hoc emails to customers and prospects.<br />Get going faster, and save time, with a starter pack of Follow-ups from Outbound Commerce.', 'follow_up_emails')
        ) );
