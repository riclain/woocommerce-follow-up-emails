...
class FUE_Install {
    ...
    public function install() {
        ...
        if ( version_compare( $current_db_version, '7.19.4', '<' ) && null !== $current_db_version ) {
    ...
    public function update() {
        ...
        if ( version_compare( $db_version, '7.15', '<' ) ) {
            include( 'updates/update-7.15.php');
            update_option( 'fue_db_version', '7.15' );
        }

        if ( version_compare( $db_version, '7.17', '<' ) ) {
            include( 'updates/update-7.17.php');
            update_option( 'fue_db_version', '7.17' );
        }

        if ( version_compare( $db_version, '7.18', '<' ) ) {
            include( 'updates/update-7.18.php');
            update_option( 'fue_db_version', '7.18' );
        }

        if ( version_compare( $db_version, '7.19.4', '<' ) ) {
            include( 'updates/update-7.19.4.php');
    ...
    private function create_tables() {
        ...
        ALTER IGNORE TABLE wp_followup_email_excludes ADD UNIQUE INDEX unique_email (email);
        ";
