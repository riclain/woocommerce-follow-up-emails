...
class FUE_Addon_Sensei {
    ...
    public function register_email_type( $types ) {
        ...
        $props = array(
            ...
            'long_description'      => __('Create emails to send based upon the quiz/course/lesson/test status you define for Sensei.<br />Get going faster, and save time, with a starter pack of Follow-ups from Outbound Commerce.', 'follow_up_emails'),
            'short_description'     => __('Create emails to send based upon the quiz/course/lesson/test status you define for Sensei.<br />Get going faster, and save time, with a starter pack of Follow-ups from Outbound Commerce.', 'follow_up_emails')
        );
