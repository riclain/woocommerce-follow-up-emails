...
class FUE_Addon_Points_And_Rewards {
    ...
    public function register_email_type( $types ) {
        ...
        $props = array(
            ...
            'long_description'      => __('Points and Rewards emails will send to a user based upon the point earnings status you define when creating your emails.<br />Get going faster, and save time, with a starter pack of Follow-ups from Outbound Commerce.', 'follow_up_emails'),
            'short_description'     => __('Points and Rewards emails will send to a user based upon the point earnings status you define when creating your emails.<br />Get going faster, and save time, with a starter pack of Follow-ups from Outbound Commerce.', 'follow_up_emails')
        );
