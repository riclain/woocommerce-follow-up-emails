...
class FUE_Addon_Woocommerce {
    ...
    public function register_email_types( $types ) {
        ...
        $props = array(
            ...
            'long_description'      => __('Create your emails for all, or specific, products or categories as well as abandoned carts.<br />Get going faster, and save time, with a starter pack of Follow-ups from Outbound Commerce.', 'follow_up_emails'),
            'short_description'     => __('Create your emails for all, or specific, products or categories as well as abandoned carts.<br />Get going faster, and save time, with a starter pack of Follow-ups from Outbound Commerce.', 'follow_up_emails'),
        ...
        $props = array(
            ...
            'durations'             => Follow_Up_Emails::$durations,
            'long_description'      => __('Engage your customers by following up with emails specifically related to customer lifetime value metrics.<br />Get going faster, and save time, with a starter pack of Follow-ups from Outbound Commerce.', 'follow_up_emails'),
            'short_description'     => __('Engage your customers by following up with emails specifically related to customer lifetime value metrics.<br />Get going faster, and save time, with a starter pack of Follow-ups from Outbound Commerce.', 'follow_up_emails'),
            'list_template'         => FUE_TEMPLATES_DIR .'/email-list/storewide-list.php'
        );
        ...
        if ( !$this->exclude_quantity_email_type() ) {
            $props   = array(
                ...
                'durations'         => Follow_Up_Emails::$durations,
                'long_description'  => __( 'Quantity emails are deprecated. Please switch to Storewide.<br />Get going faster, and save time, with a starter pack of Follow-ups from Outbound Commerce.', 'follow_up_emails' ),
                'short_description' => __( 'Quantity emails are deprecated. Please switch to Storewide.<br />Get going faster, and save time, with a starter pack of Follow-ups from Outbound Commerce.', 'follow_up_emails' ),
                'list_template'     => FUE_TEMPLATES_DIR . '/email-list/storewide-list.php'
            );
    ...
    public function handle_redirect_to_cart() {
        if ( !isset( $_GET['fue_cart_redirect'] ) || !is_cart() ) {
            return;
        }
