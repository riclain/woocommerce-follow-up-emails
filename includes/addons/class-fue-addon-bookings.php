...
class FUE_Addon_Bookings {
    ...
    public function register_email_type( $types ) {
        ...
        $props = array(
            ...
            'long_description'      => __('Send follow-up emails to customers that book appointments, services or rentals.<br />Get going faster, and save time, with a starter pack of Follow-ups from Outbound Commerce.', 'follow_up_emails'),
            'short_description'     => __('Send follow-up emails to customers that book appointments, services or rentals.<br />Get going faster, and save time, with a starter pack of Follow-ups from Outbound Commerce.', 'follow_up_emails')
        );
