...
class FUE_Addon_Woocommerce_Admin {
    ...
    public function storewide_variables( $email ) {
        ...
        <li class="var hideable var_interval_downloadable_file_added"><strong>{download_url}</strong>  <img class="help_tip" title="<?php _e('The URL of the downloadable file.', 'follow_up_emails'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
        <li class="var hideable var_interval_downloadable_file_added"><strong>{download_filename}</strong>  <img class="help_tip" title="<?php _e('The name of the downloadable file.', 'follow_up_emails'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
        <?php
