...
class FUE_Addon_Subscriptions extends FUE_Addon_Woocommerce_Scheduler {
    ...
    public function register_email_type( $types ) {
        ...
        $props = array(
            ...
            'long_description'      => __('Create emails to send to a user based upon the subscription statuses of your customers.<br />Get going faster, and save time, with a starter pack of Follow-ups from Outbound Commerce.', 'follow_up_emails'),
            'short_description'     => __('Create emails to send to a user based upon the subscription statuses of your customers.<br />Get going faster, and save time, with a starter pack of Follow-ups from Outbound Commerce.', 'follow_up_emails'),
