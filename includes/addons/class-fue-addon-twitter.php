...
class FUE_Addon_Twitter {
    ...
    public function register_email_types( $types ) {
        ...
        $props = array(
            ...
            'long_description'      => __('Collect @twitter usernames from your customers and create followups that tweet messages to your customers.<br />Get going faster, and save time, with a starter pack of Follow-ups from Outbound Commerce.', 'follow_up_emails'),
            'short_description'     => __('Collect @twitter usernames from your customers and create followups that tweet messages to your customers.<br />Get going faster, and save time, with a starter pack of Follow-ups from Outbound Commerce.', 'follow_up_emails'),
