...
class FUE_Email {
    ...
    public function get_preview_url() {
        ...
        $url = wp_nonce_url( $url, 'fue-preview', 'key' );
    ...
    public function update_status( $new_status ) {
        ...
        FUE_Email_Logger::log( $this->id, sprintf(__('<p>Email attributes updated:</p><p><strong>status</strong> from <em>%s</em> to <em>%s</em></p>', 'follow_up_emails'), $old_status, $new_status ) );
    }
