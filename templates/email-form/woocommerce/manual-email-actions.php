...
<div class="send-type-product send-type-div">
    <input type="hidden" id="product_ids" name="product_ids[]" class="wc-product-search" data-action="fue_wc_json_search_products_and_variations" data-multiple="true" data-placeholder="<?php _e('Search for a product&hellip;', 'woocommerce'); ?>" style="width: 600px"></select>
</div>
