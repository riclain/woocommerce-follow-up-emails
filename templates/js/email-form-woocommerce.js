...
jQuery( function( $ ) {
    ...
    $("#fue-email-details").on("change", "#interval_type", function () {
        ...
        if ( $(this).val() == "downloadable_file_added" ) {
            $(".var_interval_downloadable_file_added").show();
        } else {
            $(".var_interval_downloadable_file_added").hide();
        }
...
function woocommerce_toggle_fields( type ) {
    ...
    if ( type == 'customer' ) {
        ...
        hide.push('.interval_type_order_total_above', '.interval_type_order_total_below', '.interval_type_purchase_above_one', '.interval_type_total_purchases', '.interval_type_total_orders', '.interval_type_total_purchases', '.interval_type_after_last_purchase', '.var_customer', '.downloadables_div');
    }
