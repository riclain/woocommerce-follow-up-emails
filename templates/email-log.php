    ...
    <form id="email-history" action="" method="get">
        ...
        <div class="tablenav top">
            <div class="alignleft actions">
                <select id="email_filter" name="id">
                    <option selected="selected" value="">Select Email</option>
        ...
        <table class="wp-list-table widefat fixed posts">
            ...
            <?php
                ...
                foreach ( $logs as $log ):
                    $email  = new FUE_Email( $log->comment_post_ID );
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo $log->comment_author; ?></td>
                    <td><?php echo $log->comment_content; ?></td>
                    <td><?php echo $log->comment_date; ?></td>
                </tr>
            <?php
                endforeach;
            endif;
