...
<div class="section" id="manual_mails" style="display:none;">
    ...
    <div class="followup-description">
	    <div class="followup-logo">
	        ...
	        <a class="button button-primary" href="https://www.outboundcommerce.com/?utm_source=follow-up-emails&utm_medium=promo&utm_campaign=manual" target="_blank">Learn More</a>
	    </div>
    </div>
