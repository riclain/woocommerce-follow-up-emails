...
<div class="section" id="<?php echo $type->id; ?>_mails">
    ...
    <div class="followup-description">
	    <div class="followup-logo">
	        ...
	        <a class="button button-primary" href="https://www.outboundcommerce.com/?utm_source=follow-up-emails&utm_medium=promo&utm_campaign=simple" target="_blank">Learn More</a>
	    </div>
    </div>
